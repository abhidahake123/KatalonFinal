...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/h2_Profile'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Under construction'))
